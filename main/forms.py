...
class BookingForm(forms.Form):
    ...
    phone = forms.IntegerField(label='شماره موبایل',error_messages={'required':'وارد کردن شماره موبایل اجباری است.'},widget=forms.NumberInput(attrs={'class':'form-control','placeholder':'09121234567'}))
